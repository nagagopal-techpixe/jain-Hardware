...
const ProductListView = () => {
  ...
  <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="bg-white p-6 rounded-xl border sticky top-24">
        ...
        {!categoriesLoading ? (
          categoryNames.map(cat => (
            <label
              key={cat}
              className="flex gap-2 mb-2 cursor-pointer text-sm text-gray-700"
            >
              <input
                type="radio"
        ...
        {subCategories.length > 0 && (
          <div className="mt-4">
            <h4 className="font-semibold mb-2 text-sm">Subcategories</h4>
        ...
        <div className="mt-4">
          <h4 className="font-semibold mb-2 text-sm">
            Max Price: KWD {filterPrice.toFixed(0)}
          </h4>
    ...
    <div className="flex-1">
      ...
      {loading ? (
        <p className="text-center text-sm">Loading products...</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {filteredProducts.map(product => (
              ...
              >
                ...
                />
                {/* Title */}
                <h3 className="font-everest font-normal mt-2 text-sm text-gray-900 line-clamp-2">
  {product.name}
</h3>
